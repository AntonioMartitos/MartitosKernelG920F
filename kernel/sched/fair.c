 ...
 * (default: 0,5ms * (1 + ilog(ncpus)), units: nanoseconds)
 *
 ...
 */
unsigned int sysctl_sched_latency = 0500000ULL;
unsigned int normalized_sysctl_sched_latency = 0500000ULL;
...
unsigned int hmp_up_threshold = 735;
